...
var doc = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/k8s.SwagCreateWorkerBody"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/k8s/{namespace}/app/{name}/pod/{podName}/container/{containerName}/file": {
            "get": {
        ...
        "/k8s/{namespace}/app/{name}/pod/{podName}/container/{containerName}/file/v2": {
            "get": {
        ...
        "/k8s/{namespace}/app/{name}/pod/{podName}/container/{containerName}/logs": {
            "get": {
        ...
        "/k8s/{namespace}/app/{name}/pod/{podName}/container/{containerName}/logs/download": {
            "get": {
        ...
        "/k8s/{namespace}/app/{name}/pod/{podName}/portforward": {
            "get": {
                "consumes": [
                    "application/json"
                ],
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/user.GetUsersOut"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "k8s.SwagCreateWorkerBody": {
            "type": "object",
            "properties": {
                "component": {
                    "$ref": "#/definitions/types.WorkerComponent"
                },
                "metadata": {
                    "$ref": "#/definitions/types.K8sKey"
                }
            }
        },
        "model.Permission": {
            ...
            "properties": {
                "properties": {
                    ...
                    "properties": {
                        ...
                        "livenessProbe": {
                            "$ref": "#/definitions/types.HealthProbe"
                        },
                        "memory": {
                            "type": "string"
                        },
                ...
                "traits": {
                    ...
                    "properties": {
                        ...
                        "configMap": {
                            "$ref": "#/definitions/types.ConfigMap"
                        },
                        "expose": {
                            "$ref": "#/definitions/types.Expose"
                        },
                        "ingress": {
                            "$ref": "#/definitions/types.TraitIngress"
                        },
                        "initContainer": {
                            "$ref": "#/definitions/types.InitContainer"
                        },
                        "labels": {
                            "$ref": "#/definitions/types.Labels"
                        },
                        "myEnv": {
                            "$ref": "#/definitions/types.MyEnv"
                        },
                        "ports": {
                            "$ref": "#/definitions/types.MyPorts"
                        },
                        "pvc": {
                            "$ref": "#/definitions/types.Pvc"
                        },
                        "scaler": {
                            "$ref": "#/definitions/types.Scaler"
                        },
                        "sidecar": {
                            "$ref": "#/definitions/types.Sidecar"
                        },
                        "test": {
                            "type": "object"
                        }
